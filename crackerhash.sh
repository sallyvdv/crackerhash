...
$binary -O -a 6 --session $sess -m 1000 $hashes $wordlist1 ?a?a?a --increment --potfile-path $potfile
$binary -O -a 7 --session $sess -m 1000 $hashes ?a?a?a $wordlist1 --increment --potfile-path $potfile
...
$binary -O -a 0 --session $sess -m 1000 $hashes $wordlist1 --rules ~/tools/rules/dive.rule --rules ~/tools/rules/toggles1.rule -j '$!' --potfile-path $potfile
$binary -O -a 0 --session $sess -m 1000 $hashes $wordlist1 --rules ~/tools/rules/d3ad0ne.rule --rules ~/tools/rules/toggles1.rule -j '$!'  --potfile-path $potfile
$binary -O -a 0 --session $sess -m 1000 $hashes $wordlist1 --rules ~/tools/rules/best64.rule --rules ~/tools/rules/toggles1.rule  -j '$!' --potfile-path $potfile
$binary -O -a 0 --session $sess -m 1000 $hashes $wordlist1 --rules ~/tools/rules/generated2.rule --rules ~/tools/rules/toggles1.rule  -j '$!' --potfile-path $potfile
$binary -O -a 0 --session $sess -m 1000 $hashes $wordlist1 --rules ~/tools/rules/generated.rule --rules ~/tools/rules/toggles1.rule  -j '$!' --potfile-path $potfile
$binary -O -a 0 --session $sess -m 1000 $hashes $wordlist1 --rules ~/tools/rules/toggles1.rule --rules ~/tools/rules/toggles1.rule  -j '$!' --potfile-path $potfile
$binary -O -a 0 --session $sess -m 1000 $hashes $wordlist1 --rules ~/tools/rules/leetspeak.rule --rules ~/tools/rules/toggles1.rule  -j '$!'  --potfile-path $potfile
$binary -O -a 0 --session $sess -m 1000 $hashes $wordlist1 --rules ~/tools/rules/Incisive-leetspeak.rule --rules ~/tools/rules/toggles1.rule  -j '$!'  --potfile-path $potfile
$binary -O -a 0 --session $sess -m 1000 $hashes $wordlist1 --rules ~/tools/rules/unix-ninja-leetspeak.rule --rules ~/tools/rules/toggles1.rule  -j '$!' --potfile-path $potfile
$binary -O -a 0 --session $sess -m 1000 $hashes $wordlist1 --rules ~/tools/rules/toggles2.rule --rules ~/tools/rules/toggles1.rule  -j '$!' --potfile-path $potfile
$binary -O -a 0 --session $sess -m 1000 $hashes $wordlist1 --rules ~/tools/rules/toggles3.rule --rules ~/tools/rules/toggles1.rule  -j '$!' --potfile-path $potfile
$binary -O -a 0 --session $sess -m 1000 $hashes $wordlist1 --rules ~/tools/rules/toggles4.rule --rules ~/tools/rules/toggles1.rule  -j '$!' --potfile-path $potfile

# Try the targeted wordlist with each rule + toggles2 and add an exclamation point at the end of each guess
$binary -O -a 0 --session $sess -m 1000 $hashes $wordlist1 --rules ~/tools/rules/dive.rule --rules ~/tools/rules/toggles2.rule -j '$!' --potfile-path $potfile
$binary -O -a 0 --session $sess -m 1000 $hashes $wordlist1 --rules ~/tools/rules/d3ad0ne.rule --rules ~/tools/rules/toggles2.rule -j '$!'  --potfile-path $potfile
$binary -O -a 0 --session $sess -m 1000 $hashes $wordlist1 --rules ~/tools/rules/best64.rule --rules ~/tools/rules/toggles2.rule  -j '$!' --potfile-path $potfile
$binary -O -a 0 --session $sess -m 1000 $hashes $wordlist1 --rules ~/tools/rules/generated2.rule --rules ~/tools/rules/toggles2.rule  -j '$!' --potfile-path $potfile
$binary -O -a 0 --session $sess -m 1000 $hashes $wordlist1 --rules ~/tools/rules/generated.rule --rules ~/tools/rules/toggles2.rule  -j '$!' --potfile-path $potfile
$binary -O -a 0 --session $sess -m 1000 $hashes $wordlist1 --rules ~/tools/rules/toggles1.rule --rules ~/tools/rules/toggles2.rule  -j '$!' --potfile-path $potfile
$binary -O -a 0 --session $sess -m 1000 $hashes $wordlist1 --rules ~/tools/rules/leetspeak.rule --rules ~/tools/rules/toggles2.rule  -j '$!'  --potfile-path $potfile
$binary -O -a 0 --session $sess -m 1000 $hashes $wordlist1 --rules ~/tools/rules/Incisive-leetspeak.rule --rules ~/tools/rules/toggles2.rule  -j '$!'  --potfile-path $potfile
$binary -O -a 0 --session $sess -m 1000 $hashes $wordlist1 --rules ~/tools/rules/unix-ninja-leetspeak.rule --rules ~/tools/rules/toggles2.rule  -j '$!' --potfile-path $potfile
$binary -O -a 0 --session $sess -m 1000 $hashes $wordlist1 --rules ~/tools/rules/toggles2.rule --rules ~/tools/rules/toggles2.rule  -j '$!' --potfile-path $potfile
$binary -O -a 0 --session $sess -m 1000 $hashes $wordlist1 --rules ~/tools/rules/toggles3.rule --rules ~/tools/rules/toggles2.rule  -j '$!' --potfile-path $potfile
$binary -O -a 0 --session $sess -m 1000 $hashes $wordlist1 --rules ~/tools/rules/toggles4.rule --rules ~/tools/rules/toggles2.rule  -j '$!' --potfile-path $potfile
...
# $binary -O -a 0 --session $sess -m 1000 $hashes $wordlist2 --rules ~/tools/rules/dive.rule --rules ~/tools/rules/toggles1.rule -j'$!' --potfile-path $potfile
$binary -O -a 0 --session $sess -m 1000 $hashes $wordlist2 --rules ~/tools/rules/d3ad0ne.rule --rules ~/tools/rules/toggles1.rule -j'$!' --potfile-path $potfile
$binary -O -a 0 --session $sess -m 1000 $hashes $wordlist2 --rules ~/tools/rules/best64.rule --rules ~/tools/rules/toggles1.rule -j'$!' --potfile-path $potfile
$binary -O -a 0 --session $sess -m 1000 $hashes $wordlist2 --rules ~/tools/rules/generated2.rule --rules ~/tools/rules/toggles1.rule -j'$!' --potfile-path $potfile
$binary -O -a 0 --session $sess -m 1000 $hashes $wordlist2 --rules ~/tools/rules/generated.rule --rules ~/tools/rules/toggles1.rule -j'$!' --potfile-path $potfile
$binary -O -a 0 --session $sess -m 1000 $hashes $wordlist2 --rules ~/tools/rules/toggles1.rule --rules ~/tools/rules/toggles1.rule -j'$!' --potfile-path $potfile
$binary -O -a 0 --session $sess -m 1000 $hashes $wordlist2 --rules ~/tools/rules/leetspeak.rule --rules ~/tools/rules/toggles1.rule -j'$!' --potfile-path $potfile
$binary -O -a 0 --session $sess -m 1000 $hashes $wordlist2 --rules ~/tools/rules/Incisive-leetspeak.rule --rules ~/tools/rules/toggles1.rule -j'$!' --potfile-path $potfile
$binary -O -a 0 --session $sess -m 1000 $hashes $wordlist2 --rules ~/tools/rules/unix-ninja-leetspeak.rule --rules ~/tools/rules/toggles1.rule -j'$!' --potfile-path $potfile
$binary -O -a 0 --session $sess -m 1000 $hashes $wordlist2 --rules ~/tools/rules/toggles2.rule --rules ~/tools/rules/toggles1.rule -j'$!' --potfile-path $potfile
$binary -O -a 0 --session $sess -m 1000 $hashes $wordlist2 --rules ~/tools/rules/toggles3.rule --rules ~/tools/rules/toggles1.rule -j'$!' --potfile-path $potfile
$binary -O -a 0 --session $sess -m 1000 $hashes $wordlist2 --rules ~/tools/rules/toggles4.rule --rules ~/tools/rules/toggles1.rule -j'$!' --potfile-path $potfile
...
$binary -O -a 1 --session $sess -m 1000 $hashes $wordlist1 $wordlist1 --rule-right ~/tools/rules/dive.rule
$binary -O -a 1 --session $sess -m 1000 $hashes $wordlist2 $wordlist1 --rule-right ~/tools/rules/d3ad0ne.rule

# Hybrid Mask Attack Appending and Prending 4 characters
$binary -O -a 6 --session $sess -m 1000 $hashes $wordlist1 ?a?a?a?a --potfile-path $potfile
$binary -O -a 7 --session $sess -m 1000 $hashes ?a?a?a?a $wordlist1 --potfile-path $potfile
